    ...
    <div className='bg-darkGreen '>
      <div className='max-w-[1440px] mx-auto relative pb-[322px] max-md:pb-52 max-sm:pb-[175px]'>
        <div className='max-w-[1358px] px-4 mx-auto'>
          ...
          <form action="#" className='flex items-center border-2 rounded-[50px] border-white  pr-[37.95px] relative mx-auto max-w-[448px] max-sm:px-6 '>
            <input type="text" placeholder='Enter Your Website' className='bg-transparent w-full h-full py-[22px] sm:pl-[34.27px] max-sm:py-[22px] outline-none font-maisonBook text-[15px] leading-5 text-white text-opacity-40' />
